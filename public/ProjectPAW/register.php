        ...
        <div class="card-body">
            <div class="row justify-content-center">
                <div class="col-md-6 align-self-center">
                    ...
                    <div class="text-center"> <a href="#" class="btn mb-5">REGISTER</a></div>
                    
                </div>
                <div class="col-md-6" style="background-color: #B4CAFC;"><img src="image/register.png" class="img-fluid"></div>
            </div>
        </div>
        </div>
        </div>
